...
const ReturnInvoiceModal: React.FC<ReturnInvoiceModalProps> = ({ visible, onHide, returnInvoiceData }) => {
    ...
    return (
        <Dialog visible={visibleModal} style={{ width: '50vw' }} onHide={onHide}>
            <div className='space-y-6 p-6 bg-white rounded-lg shadow-lg max-w-3xl mx-auto'>
                ...
                <div className='space-y-2'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <span className='text-gray-600'>
                            {returnInvoiceData.firstName} {returnInvoiceData.lastName}
                        </span>
                    </div>
                    <div className='flex items-center'>
                ...
                <DataTable showGridlines value={returnInvoiceData.returnItems} className='mt-4'>
                    <Column
                        header='STT'
                        body={(rowData) => {
                ...
                <div className='flex justify-between gap-4 mt-6'>
                    ...
                    <Button
                        label='In Hóa Đơn'
                        icon='pi pi-print'
                        onClick={() => console.log('Invoice Confirmed')}
                        className='flex-1'
                    />
                </div>
            </div>
