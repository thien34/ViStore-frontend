                ...
                <div className='grid'>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('lara-light-indigo', 'light')}>
                            <Image alt='Lara Light Indigo' className='w-2rem h-2rem' src='/layout/images/themes/lara-light-indigo.png' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('lara-light-blue', 'light')}>
                            <Image alt='Lara Light Blue' className='w-2rem h-2rem' src='/layout/images/themes/lara-light-blue.png' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('lara-light-purple', 'light')}>
                            <Image src='/layout/images/themes/lara-light-purple.png' className='w-2rem h-2rem' alt='Lara Light Purple' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('lara-light-teal', 'light')}>
                            <Image src='/layout/images/themes/lara-light-teal.png' className='w-2rem h-2rem' alt='Lara Light Teal' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('lara-dark-indigo', 'dark')}>
                            <Image src='/layout/images/themes/lara-dark-indigo.png' className='w-2rem h-2rem' alt='Lara Dark Indigo' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('lara-dark-blue', 'dark')}>
                            <Image src='/layout/images/themes/lara-dark-blue.png' className='w-2rem h-2rem' alt='Lara Dark Blue' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('lara-dark-purple', 'dark')}>
                            <Image src='/layout/images/themes/lara-dark-purple.png' className='w-2rem h-2rem' alt='Lara Dark Purple' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('lara-dark-teal', 'dark')}>
                            <Image src='/layout/images/themes/lara-dark-teal.png' className='w-2rem h-2rem' alt='Lara Dark Teal' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('soho-light', 'light')}>
                            <Image src='/layout/images/themes/soho-light.png' className='w-2rem h-2rem' alt='Soho Light' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('soho-dark', 'dark')}>
                            <Image src='/layout/images/themes/soho-dark.png' className='w-2rem h-2rem' alt='Soho Dark' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('viva-light', 'light')}>
                            <Image src='/layout/images/themes/viva-light.svg' className='w-2rem h-2rem' alt='Viva Light' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('viva-dark', 'dark')}>
                            <Image src='/layout/images/themes/viva-dark.svg' className='w-2rem h-2rem' alt='Viva Dark' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                </div>
                ...
                <div className='grid'>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('bootstrap4-light-blue', 'light')}>
                            <Image src='/layout/images/themes/bootstrap4-light-blue.svg' className='w-2rem h-2rem' alt='Bootstrap Light Blue' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('bootstrap4-light-purple', 'light')}>
                            <Image src='/layout/images/themes/bootstrap4-light-purple.svg' className='w-2rem h-2rem' alt='Bootstrap Light Purple' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('bootstrap4-dark-blue', 'dark')}>
                            <Image src='/layout/images/themes/bootstrap4-dark-blue.svg' className='w-2rem h-2rem' alt='Bootstrap Dark Blue' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('bootstrap4-dark-purple', 'dark')}>
                            <Image src='/layout/images/themes/bootstrap4-dark-purple.svg' className='w-2rem h-2rem' alt='Bootstrap Dark Purple' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                </div>
                ...
                <div className='grid'>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('md-light-indigo', 'light')}>
                            <Image src='/layout/images/themes/md-light-indigo.svg' className='w-2rem h-2rem' alt='Material Light Indigo' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('md-light-deeppurple', 'light')}>
                            <Image src='/layout/images/themes/md-light-deeppurple.svg' className='w-2rem h-2rem' alt='Material Light DeepPurple' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('md-dark-indigo', 'dark')}>
                            <Image src='/layout/images/themes/md-dark-indigo.svg' className='w-2rem h-2rem' alt='Material Dark Indigo' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('md-dark-deeppurple', 'dark')}>
                            <Image src='/layout/images/themes/md-dark-deeppurple.svg' className='w-2rem h-2rem' alt='Material Dark DeepPurple' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                </div>
                ...
                <div className='grid'>
                    ...
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('mdc-light-deeppurple', 'light')}>
                            <Image src='/layout/images/themes/md-light-deeppurple.svg' className='w-2rem h-2rem' alt='Material Light Deep Purple' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                    <div className='col-3'>
                    ...
                    <div className='col-3'>
                        <button className='p-link w-2rem h-2rem' onClick={() => _changeTheme('mdc-dark-deeppurple', 'dark')}>
                            <Image src='/layout/images/themes/md-dark-deeppurple.svg' className='w-2rem h-2rem' alt='Material Dark Deep Purple' layout='responsive' width={28} height={28} />
                        </button>
                    </div>
                </div>
            </Sidebar>
